...
public interface IBaseService<TEntity> where TEntity : class
{
    ...
    /// <param name="where">Expression<Func<T, bool>></param>
    /// <returns></returns>
    Task<bool> DeleteAsync(Expression<Func<TEntity, Object>> columns, Expression<Func<TEntity, bool>> where);
    ...
    /// <returns></returns>
    Task<bool> UpdateAsync(Expression<Func<TEntity, Object>> columns, Expression<Func<TEntity, bool>> where);
    ...
    /// <returns></returns>
    Task<List<TEntity>> QueryAsync(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>>? strOrderByFileds = null);
    ...
    /// <returns></returns>
    Task<List<TEntity>> QueryPageAsync(Expression<Func<TEntity, bool>> whereExpression, int intPageIndex = 0, int intPageSize = 20, Expression<Func<TEntity, object>>? strOrderByFileds = null);
